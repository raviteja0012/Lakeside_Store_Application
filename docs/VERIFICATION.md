...
| Full Excel export with relationships (/api/export) | PR #9, 2026-07-08 | Table list checked against schema.sql column by column; pagination beyond 1000 rows; parent-scoped tables chunk their id lists; owner/manager gate mirrors /api/import; machine gates green | Verified, awaiting owner |
